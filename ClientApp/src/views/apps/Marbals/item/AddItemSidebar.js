...
const AddItemSidebar = props => {
    ...
    const onSubmitData = async () => {
        ...
        await fetch(`${process.env.REACT_APP_API_LINK}api/Radharani/Addproduct`, {
            method: 'POST',
            headers: {
        ...
        >
            <Card>
                <CardHeader className='border-bottom'>
                    <CardTitle tag='h4'>Add Items</CardTitle>
                </CardHeader>
                    ...
                    <Form className=' pt-50' onSubmit={handleSubmit(onSubmit)}>
                        <Row>
                            <Col sm='12' className='mb-1'>
                                ...
                                <Input id='lotno' name='lotno' onChange={(e) => onInputChange(e)} value={formData.lotno} placeholder="e.g: 'BLACK STONE- 2'0" />
                            ...
                            <Col sm='12' className='mb-1'>
                                ...
                                <Input id='size' name="size" placeholder="e.g: '12*12'" onChange={(e) => onInputChange(e)} value={formData.size} />
                            ...
                            <Col sm='12' className='mb-1'>
                                ...
                                <Input id='thikness' type='text' name='thikness' onChange={(e) => onInputChange(e)} placeholder="e.g: '2*2'" value={formData.thikness} />
                            </Col>
                            ...
                            <Col sm='12' className='mb-1'>
                                ...
                                <Input id='qunatity' name='qunatity' onChange={(e) => onInputChange(e)} value={formData.qunatity} placeholder="e.g: '2196.00 SQF'" />
                            </Col>
                            <Col sm='12' className='mb-1'>
                                <Label className='form-label' for='address'>
                                    <b>Price</b>
                                </Label>
                                <Input id='price' name='price' onChange={(e) => onInputChange(e)} value={formData.price} placeholder="e.g: 'Rs. 1520'" />
                            </Col>
                            <Col sm='12' className='mb-1'>
                            ...
                            <Col sm='12' className='mb-1'>
                                ...
                                <Input id='gst' name='gst' onChange={(e) => onInputChange(e)} value={formData.gst} placeholder="e.g: '15%'" />
                            </Col>

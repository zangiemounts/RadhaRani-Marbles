...
const MesurementLessViewPrint = ({ setdatarefresh, value }) => {
    ...
    return (<>
                                    ...
                                    {userdata.length > 0 ? userdata.map((data, index) => (
                                            <div style={{ display: 'flex', minWidth:"80%" }} key={index}>
                                                <span style={{ flex: 1, border: "1px solid black", textAlign: "center" }} className='fw-bold'> Less {index + 1} </span>

                                                <span style={{ flex: 1, border: "1px solid black", textAlign: "center" }} className='fw-bold'>{data.workFlowId}</span>

                                                <span style={{ flex: 1, border: "1px solid black", textAlign: "center" }} className='fw-bold'>X</span>

                                                <span style={{ flex: 1, border: "1px solid black", textAlign: "center" }} className='fw-bold'>{data.insuranceId}</span>
                                            </div>
...
export default MesurementLessViewPrint

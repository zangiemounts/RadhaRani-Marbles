...
import { Plus, Edit3, PlusCircle, Trash2 } from 'react-feather'
...
const Employee = () => {
  ...
  /* useEffect(() => {
        if (filteredData1.length > 0) {
            setFormData({ ...formData, OrgName: filteredData1[0]?.userdata?.firstName })
        }
    }, [filteredData1])*/
            ...
            {IsDataLoading ? (
              ...
              paginatedData.map((details, index) => (
                <tr key={index}>
                  ...
                  {/* <td className="p-2">
                                            {details.roleCatId === 90 ? "Employee" : "Customer"}
                                        </td>*/}
                  <td className='p-2'>
                ...
                <Col className='mt-2' sm='12'>
                  {!IsLoading ? (
                    <Button
                      ...
                      color='success'
                    >
                      <PlusCircle size={20} /> Update Employee
                    </Button>
                  ) : (

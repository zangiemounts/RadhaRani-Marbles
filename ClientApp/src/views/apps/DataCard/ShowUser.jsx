    ...
    return (
        <Fragment>
                <Card className='overflow-hidden'>
                    ...
                    <Row>
                        <Col>
                            <Button className='mb-2 mx-2' color="success" onClick={() => handleTaskSidebar()}>  <Plus size={20} />Add Customer</Button>
                            {/*<AddUsers />*/}
                        </Col>
                    </Row>
                            <Table responsive>
                                ...
                                <tbody>
                                    ...
                                    {paginatedData !== [] ? paginatedData.map((details, index) => <tr>
                                        ...
                                        <td>
                                            ...
                                            {details.userdata.userRoleId === 16 ? "Customer" : "Sales Executive"}
                                        </td>
                                        <td >

...
const AddMesurementSideBar = props => {
    // ** Props
                    ...
                    <Form className='mt-2 pt-50' onSubmit={handleSubmit(onSubmit)}>
                        <Row>
                            ...
                            <Col sm='12' className='mb-1'>
                                ...
                                <Input id='OrgName' name='lastName' value={formData.lastName} onChange={(e) => onInputChange(e)} placeholder="e.g: '653S sector-9'" />
                            ...
                            <Col sm='12' className='mb-3'>
                                ...
                                <Input id='OrgPhoneno' type='number' value={formData.OrgPhoneno} name='OrgPhoneno' onChange={(e) => onInputChange(e)} placeholder="e.g: 'DL55SD265'" />
                            </Col>
                            <Col sm='12' className='mb-1'>
                                <Label className='form-label' for='address'>
                                    <b> Slab</b>
                                </Label>
                                <Input id='orgAddress' type="text" name='orgAddress' value={formData.orgAddress} onChange={(e) => onInputChange(e)} placeholder="e.g: 12" />
                            </Col>
                            <Col sm='12' className='mb-1'>
                                <Label className='form-label' for='address'>
                                    <b> Size</b>
                                </Label>
                                <Input id='orgAddress2' type="text" name='orgAddress2' value={formData.orgAddress2} onChange={(e) => onInputChange(e)} placeholder="e.g: 12*12" />
                            </Col>
                            <Col sm='12' className='mb-1'>
                                <Label className='form-label' for='accountState'>
                                    <b>  Less</b>
                                </Label>
                                <Input id='OrgPin' type="number" name='OrgPin' value={formData.OrgPin} onChange={(e) => onInputChange(e)} placeholder="e.g: 1*2" />
                            </Col>
                            <Col sm='12' className='mb-1'>
                                <Label className='form-label' for='zipCode'>
                                    <b> Sft</b>
                                </Label>
                                <Input id='OrgPin' type="textarea" name='instructions' value={formData.instructions} onChange={(e) => onInputChange(e)} placeholder="e.g: 11*12" />

                            </Col>
                            <Col className='mt-2' sm='12'>
                                <Button type='submit' onClick={() => submitForm()} className='me-1' color='success'>
                                    <PlusCircle size={20}/> Add Mesurement
                                </Button>
...
export default AddMesurementSideBar

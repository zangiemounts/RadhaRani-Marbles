...
import AddEstimateSidebar from './AddEstimateSidebar'

const EstimationSheet = () => {
    ...
    return (
        <Fragment>
                <Card className='overflow-hidden'>
                    ...
                    <Row>
                        <Col>
                            <Button className='mb-2 mx-2' color="success" onClick={() => handleTaskSidebar()}> <Plus size={20} /> Add Estimation</Button>
                            {/*<AddUsers />*/}
                        </Col>
                    </Row>
                            <Table responsive>

...
import { Plus, Hash, Trash2, Eye, ArrowLeft } from 'react-feather'
...
import CheckBill from '../add/CheckBill'
                          ...
                          <div className='d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0'>
                              <div>
                                  <div className='logo-wrapper'>
                                      <img src={`https://mountsfileupload.azurewebsites.net/api/FileUpload/${Data.logoImage2}`} height='100' width='200' />
                          ...
                          <Row className='row-bill-to invoice-spacing'>
                              ...
                              <Col className='p-0 mt-xl-0 mt-2' xl='4'>
                                  ...
                                  <table>
                                      <tbody>
                                          <tr>
                                              <td className='pe-1 fw-bold'>Total Due: {(data.payableamount).toFixed(2)}</td>
                                              <td>
                                                  <span className='fw-bold'></span>
                                              </td>
                                          </tr>
                                          <tr>
                                              <td className='pe-1 fw-bold'>Bank name: {Data.urlimage4}</td>
                                              <td></td>
                                          </tr>
                                          <tr>
                                              <td className='pe-1 fw-bold'>Country: {Data.urlimage2}</td>
                                              <td></td>
                                          </tr>
                                          <tr>
                                              <td className='pe-1 fw-bold'>{Data.apikey1 === "International" ? "IBAN" : "Account No"}: {Data.urlimage5}</td>
                                              <td></td>
                                          </tr>
                                          <tr>
                                              <td className='pe-1 fw-bold'>{Data.apikey1 === "International" ? "SWIFT code" : "IFSC Code" }: {Data.urlimage3}</td>
                                              <td></td>
                                          </tr>
                                      </tbody>
                                  </table>
                  ...
                  <Card className='invoice-action-wrapper'>
                      <CardBody>
                         {/* <Button color='primary' block className='mb-75' disabled>
                          ...
                          {/* <Button color='secondary' tag={Link} to={query} target='_blank' block outline className='mb-75'>
                              Print
                          </Button>*/}

...
import { Plus, Hash, Trash2 } from 'react-feather'
          ...
          <div className='d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0'>
            <div>
              <div className='logo-wrapper'>
                 ...
                 <p className='card-text mb-25'>{Data.mainDesc}</p>
                  <p className='card-text mb-25'>{`${Data.domainDesc} ${Data.urlimage1} ${Data.urlimage2} ${Data.remarks}`}</p>
            ...
            <div className='invoice-number-date mt-md-0 mt-2'>
              ...
              <div className='d-flex align-items-center'>
                ...
                <Flatpickr
                  options={{ minDate: userdata.createdOn, dateFormat: "Y-m-d" }}
                  value={dueDatepicker}
          ...
          <Row className='row-bill-to invoice-spacing'>
            <Col className='col-bill-to ps-0' xl='8'>
              <h6 className='invoice-to-title'>Invoice To:</h6>
                <p className='mb-25'>{`${userdata.mainDesc} ${userdata.columRemarks}`}</p>
                <p className='mb-0'>{`${userdata.urlimage2}`}</p>
                <p className='mb-0'>{`${userdata.urlimage1}`}</p>
                <p className='mb-25'>{`${userdata.urlimage3} ${userdata.ocremarks} ${userdata.urlimage4} ${userdata.urlimage5}`}</p>
                              ...
                              <Col className='p-0 mt-xl-0 mt-2' xl='4'>
                                  ...
                                  <table>
                                      <tbody>
                                          ...
                                          <tr>
                                              <td className='pe-1 fw-bold'>Bank Address: <i style={{ color: "blue" }}>{BankData.columRemarks}</i></td>
                                              <td></td>
                                          </tr>
                                          <tr>
                                              <td className='pe-1 fw-bold'>Bank State: <i style={{ color: "blue" }}>{BankData.oremarks}</i></td>
                                              <td></td>
                                          </tr>
                                          <tr>
                                              <td className='pe-1 fw-bold'>Country: <i style={{ color: "blue" }}>{BankData.ocremarks}</i></td>
                                              <td></td>
                                          </tr>
                                          <tr>
        ...
        <CardBody className='invoice-padding invoice-product-details'>
                    ...
                    <Col className='d-flex product-details-border position-relative pe-0' sm='12'>
                      <Row className='w-100 pe-lg-0 pe-1 py-2'>
                        <Col className='mb-lg-0 mb-2 mt-lg-0 mt-2' lg='3' sm='12'>
                          ...
                          <Input type='text' name="Productname"onChange={(e) => onInputChange2(e)} placeholder="Enter Product Name" className='item-details'/>
                           
                        </Col>
                        <Col className='my-lg-0 my-2' lg='3' sm='12'>
                          <CardText className='col-title mb-md-2 mb-0'>Unit</CardText>
                           <Input type='text' name="unittype" onChange={(e) => onInputChange2(e)}  placeholder='Enter Unit' />
                        ...
                        <Col className='my-lg-0 mt-2' lg='2' sm='12'>
                          ...
                          <CardText className='mb-0'>{data.price * data.quantity}</CardText>
                         {/* <div className='mt-2'>
                            <span>After Discount</span>
                            <CardText className='mb-1'>{(data.price * data.quantity) - (data.discount * (data.price * data.quantity) / 100)}</CardText>
          ...
          <Row className='mt-1'>
            <Col sm='12' className='px-0'>
              <Button color='primary' size='sm' className='btn-add-new' onClick={() => getData3()}>
